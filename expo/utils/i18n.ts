...
const translations = {
  ...
  analysis_ai_badge: { fr: 'Analyse IA premium', en: 'Premium AI analysis' },
  analysis_step_photo: { fr: 'Photo', en: 'Photo' },
  analysis_step_database: { fr: 'Base', en: 'Database' },
  analysis_step_verdict: { fr: 'Verdict', en: 'Verdict' },
  analysis_progress_label: { fr: 'Inspection du produit', en: 'Product inspection' },
  analysis_fact_subtitle: { fr: "Pendant l'analyse", en: 'While analyzing' },
  analysis_tip_cta: { fr: 'En savoir plus', en: 'Learn more' },
  ...
  history_saved_subtitle: { fr: 'Tous vos scans sauvegardés', en: 'All your saved scans' },
  history_scan_count: { fr: 'scans', en: 'scans' },
  history_saved_label: { fr: 'Sauvegardé', en: 'Saved' },
  history_photo_scan: { fr: 'Photo', en: 'Photo' },
  history_barcode_scan: { fr: 'Code-barres', en: 'Barcode' },
  history_unknown_brand: { fr: 'Marque inconnue', en: 'Unknown brand' },
  history_status_carcinogenic: { fr: 'Cancérigène', en: 'Carcinogenic' },
  history_status_carcinogenic_desc: { fr: 'Risque élevé — substance cancérigène détectée', en: 'High risk — carcinogenic substance detected' },
  history_status_ultra_processed: { fr: 'Ultra-transformé', en: 'Ultra-processed' },
  history_status_ultra_processed_desc: { fr: 'À limiter — marqueurs industriels détectés', en: 'Limit intake — industrial markers detected' },
  history_status_caution: { fr: 'Modération', en: 'Caution' },
  history_status_caution_desc: { fr: 'À consommer avec modération', en: 'Consume in moderation' },
  history_status_approved: { fr: 'Approuvé', en: 'Approved' },
  history_status_approved_desc: { fr: 'Aucun signal préoccupant détecté', en: 'No concerning signal detected' },
  ...
  free_scans_counter: { fr: (remaining: number, limit: number) => `${remaining}/${limit} scans gratuits aujourd'hui — Illimité avec Pro`, en: (remaining: number, limit: number) => `${remaining}/${limit} free scans today — Unlimited with Pro` },
  scan_limit_reached_title: { fr: 'Limite quotidienne atteinte', en: 'Daily limit reached' },
  scan_limit_reached_msg: { fr: 'Vous avez utilisé vos 3 scans gratuits du jour. Passez à Pro pour scanner sans limite.', en: "You've used your 3 free scans today. Go Pro to scan without limits." },
  ...
  not_classified_unknown: { fr: 'Non classé', en: 'Not classified' },
  all_ingredients: { fr: 'Tous les ingrédients', en: 'All ingredients' },
  pro_only_listen: { fr: 'Écoute disponible avec Dr.Toxi Pro', en: 'Listen available with Dr.Toxi Pro' },
  substances_detected: { fr: 'Substances détectées', en: 'Substances detected' },
  level_confirmed_carcinogen: { fr: 'CANCÉRIGÈNE', en: 'CARCINOGENIC' },
  level_probable_carcinogen: { fr: 'NOCIF', en: 'WARNING' },
  level_possible_carcinogen: { fr: 'MODÉRATION', en: 'CAUTION' },
  level_controversial: { fr: 'NOCIF', en: 'WARNING' },
  level_low_risk: { fr: 'APPROUVÉ', en: 'APPROVED' },
  ...
  drtoxi_alternative_label: { fr: 'Suggestion de Dr. Toxi', en: 'Dr. Toxi suggestion' },
  nearby_real_stores: { fr: 'Magasins réels près de vous', en: 'Real stores near you' },
  nearby_stores_loading: { fr: 'Recherche des magasins bio et santé à 5–10 km…', en: 'Finding organic and health stores within 5–10 km…' },
  nearby_stores_empty: { fr: 'Aucun magasin bio ou santé trouvé à proximité pour le moment.', en: 'No nearby organic or health stores found right now.' },
  bio_stores_intro: { fr: 'Résultats réels basés sur votre position, sans liste générique.', en: 'Real results based on your location, no generic list.' },
  ...
  risk_caution_label: { fr: 'NOCIF', en: 'WARNING' },
  ...
  risk_warning_label: { fr: 'NOCIF', en: 'WARNING' },
  risk_warning_sub: { fr: 'Plusieurs substances controversées détectées', en: 'Multiple controversial substances detected' },
  risk_moderation_label: { fr: 'MODÉRATION', en: 'CAUTION' },
  ...
  stat_danger: { fr: 'Cancérigène', en: 'Carcinogenic' },
  stat_probable: { fr: 'Warning', en: 'Warning' },
  stat_possible: { fr: 'Caution', en: 'Caution' },
  ...
  paywall_scan: { fr: 'Scannez vos produits sans limite', en: 'Scan your products without limits' },
  ...
  paywall_sub_scan: { fr: 'Vous avez utilisé vos 3 scans gratuits du jour', en: "You've used your 3 free scans today" },
  ...
  // Badge names
  badge_name_scan_1: { fr: 'Premier pas', en: 'First Step' },
  badge_name_scan_10: { fr: 'Détective santé', en: 'Health Detective' },
  badge_name_scan_50: { fr: 'Expert en étiquettes', en: 'Label Expert' },
  badge_name_scan_100: { fr: 'Chasseur de toxines', en: 'Toxin Hunter' },
  badge_name_scan_500: { fr: 'Légende Dr.Toxi', en: 'Dr.Toxi Legend' },
  badge_name_green_1: { fr: 'Bon choix', en: 'Good Choice' },
  badge_name_green_10: { fr: 'Panier sain', en: 'Healthy Cart' },
  badge_name_green_25: { fr: 'Frigo propre', en: 'Clean Fridge' },
  badge_name_green_50: { fr: 'Maison saine', en: 'Healthy Home' },
  badge_name_green_100: { fr: 'Mode de vie sain', en: 'Healthy Lifestyle' },
  badge_name_share_1: { fr: 'Ambassadeur', en: 'Ambassador' },
  badge_name_share_10: { fr: 'Influenceur santé', en: 'Health Influencer' },
  badge_name_share_25: { fr: 'Viral', en: 'Viral' },
  badge_name_share_100: { fr: 'Ambassadeur Légendaire', en: 'Legendary Ambassador' },
  badge_name_drtoxi_1: { fr: 'Curieux', en: 'Curious Mind' },
  badge_name_drtoxi_10: { fr: 'Étudiant en santé', en: 'Health Student' },

  // Badge descriptions
  badge_desc_scan_1: { fr: 'Premier produit scanné', en: 'First product scanned' },
  badge_desc_scan_10: { fr: '10 produits scannés', en: '10 products scanned' },
  badge_desc_scan_50: { fr: '50 produits scannés', en: '50 products scanned' },
  badge_desc_scan_100: { fr: '100 produits scannés', en: '100 products scanned' },
  badge_desc_scan_500: { fr: '500 produits scannés', en: '500 products scanned' },
  badge_desc_green_1: { fr: 'Premier produit vert trouvé', en: 'First green product found' },
  badge_desc_green_10: { fr: '10 produits verts trouvés', en: '10 green products found' },
  badge_desc_green_25: { fr: '25 produits verts trouvés', en: '25 green products found' },
  badge_desc_green_50: { fr: '50 produits verts trouvés', en: '50 green products found' },
  badge_desc_green_100: { fr: '100 produits verts trouvés', en: '100 green products found' },
  badge_desc_share_1: { fr: 'Premier partage sur les réseaux sociaux', en: 'First share on social media' },
  badge_desc_share_10: { fr: '10 partages', en: '10 shares' },
  badge_desc_share_25: { fr: '25 partages', en: '25 shares' },
  badge_desc_share_100: { fr: '100 partages — Badge doré exclusif rare', en: '100 shares — Rare exclusive golden badge' },
  badge_desc_drtoxi_1: { fr: 'Première question à Dr. Toxi', en: 'First question to Dr. Toxi' },
  badge_desc_drtoxi_10: { fr: '10 questions posées', en: '10 questions asked' },
