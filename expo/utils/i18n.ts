...
const translations = {
  ...
  verdict_caution_msg: { fr: "Ce produit contient plusieurs substances controversées ou ultra-transformées. À éviter si possible — voici des alternatives plus saines ci-dessous.", en: 'This product contains several controversial or ultra-processed substances. Avoid if possible — here are healthier alternatives below.' },
