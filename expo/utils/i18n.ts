...
const translations = {
  ...
  history_status_carcinogenic_desc: { fr: 'Risque élevé — substance cancérigène détectée', en: 'High risk — carcinogenic substance detected', ko: '높은 위험 — 발암 물질 검출' },
  ...
  free_messages_counter: { fr: (remaining: number, limit: number) => `${remaining}/${limit} messages gratuits aujourd'hui — Illimité avec Pro`, en: (remaining: number, limit: number) => `${remaining}/${limit} free messages today — Unlimited with Pro`, ko: (remaining: number, limit: number) => `오늘 무료 메시지 ${remaining}/${limit} — Pro로 무제한` },
  ...
  ingredient_badge_industrial: { fr: 'INDUSTRIEL', en: 'INDUSTRIAL', ko: '산업성' },
  ...
  intro_danger: { fr: 'Ce produit contient des substances cancérigènes.', en: 'This product contains carcinogenic substances.', ko: '이 제품에는 발암 물질이 포함되어 있습니다.' },
  ...
  risk_approved_sub: { fr: 'Aucune substance cancérigène détectée', en: 'No carcinogenic substances detected', ko: '발암 물질이 검출되지 않음' },
  ...
  no_dangerous_substance: { fr: 'Aucune substance dangereuse détectée', en: 'No dangerous substances detected', ko: '위험 물질이 검출되지 않음' },
