...
const translations = {
  ...
  error_image_analysis: { fr: "Oups, j'ai pas réussi à analyser cette image. Réessaie en prenant la photo un peu plus près, avec une bonne lumière. Vise bien la liste d'ingrédients !", en: "Oops, I couldn't analyze this image. Try taking the photo a bit closer, with good lighting. Aim for the ingredient list!" },
  error_image_process: { fr: "Oups, j'ai pas réussi à traiter cette image. Réessaie avec une autre photo !", en: "Oops, I couldn't process this image. Try again with another photo!" },
