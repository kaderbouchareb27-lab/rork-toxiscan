...
const translations = {
  ...
  analysis_reading_label: { fr: "Lecture de l'étiquette…", en: 'Reading the label…' },
  analysis_checking_ingredients: { fr: 'Analyse des ingrédients…', en: 'Checking ingredients…' },
  analysis_looking_closer: { fr: 'Inspection approfondie…', en: 'Looking closer…' },
  ...
  filter_warning: { fr: 'Ultra-transformé', en: 'Ultra-processed' },
  filter_caution: { fr: 'Modération', en: 'Moderation' },
  ...
  history_status_caution: { fr: 'Modération', en: 'Moderation' },
  ...
  cosmetic_badge_toxic: { fr: 'TOXIQUE', en: 'TOXIC' },
  cosmetic_badge_disputed: { fr: 'CONTESTÉ', en: 'DISPUTED' },
  cosmetic_badge_approved: { fr: 'APPROUVÉ', en: 'APPROVED' },
  ...
  level_possible_carcinogen: { fr: 'MODÉRATION', en: 'MODERATION' },
  ...
  risk_moderation_label: { fr: 'MODÉRATION', en: 'MODERATION' },
  ...
  stat_probable: { fr: 'Ultra-transformé', en: 'Ultra-processed' },
  stat_possible: { fr: 'Modération', en: 'Moderation' },
  stat_safe: { fr: 'Approuvé', en: 'Approved' },
