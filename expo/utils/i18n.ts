...
const translations = {
  ...
  badge_toxic: { fr: 'TOXIQUE', en: 'TOXIC', ko: '독성' },
  ...
  intro_toxic: { fr: 'Ce produit franchit le seuil de toxicité (CIRC 2A/2B ou forte accumulation).', en: 'This product crosses the toxicity threshold (IARC 2A/2B or heavy accumulation).', ko: '이 제품은 독성 기준을 넘었습니다 (IARC 2A/2B 또는 과다 축적).' },
  intro_ultra_toxic: { fr: 'Cancérigène + accumulation massive d’ultra-transformés. À ne pas consommer.', en: 'Carcinogen + massive ultra-processed accumulation. Do not consume.', ko: '발암물질 + 초가공 성분의 대량 축적. 섭취하지 마세요.' },
