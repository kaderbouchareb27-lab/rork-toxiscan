...
const translations = {
  ...
  history_limit_banner: { fr: '2 derniers produits visibles — Illimité avec Pro', en: 'Last 2 products visible — Unlimited with Pro', ko: '최근 2개 제품만 표시 — Pro로 무제한' },
  ...
  history_search_placeholder: { fr: 'Rechercher un produit ou une marque…', en: 'Search a product or brand…', ko: '제품 또는 브랜드 검색…' },
  history_search_empty: { fr: 'Aucun produit ne correspond à ta recherche', en: 'No products match your search', ko: '검색 결과가 없습니다' },
  history_search_empty_hint: { fr: 'Essaie un autre nom ou une autre marque', en: 'Try another product name or brand', ko: '다른 제품명이나 브랜드를 검색해 보세요' },
  history_filter_empty: { fr: 'Aucun produit dans cette catégorie', en: 'No products in this category', ko: '이 카테고리에 제품이 없습니다' },
  history_filter_empty_hint: { fr: 'Essaie un autre filtre pour voir tes autres produits', en: 'Try another filter to see your other products', ko: '다른 필터를 사용해 다른 제품을 확인해 보세요' },
  ...
  history_status_ultra_processed: { fr: 'Transformé', en: 'Processed', ko: '가공' },
  ...
  history_status_caution: { fr: 'Modération', en: 'Occasional', ko: '주의' },
  ...
  scan_limit_reached_msg: { fr: 'Vous avez utilisé vos 2 scans gratuits du jour. Passez à Pro pour scanner sans limite.', en: "You've used your 2 free scans today. Go Pro to scan without limits.", ko: '오늘 무료 스캔 2회를 모두 사용했습니다. Pro로 업그레이드하면 무제한으로 스캔할 수 있습니다.' },
  ...
  intro_ultra_toxic: { fr: 'Vraiment préoccupant : CIRC 2A/2B ou accumulation massive d’ultra-transformés, juste un cran sous le cancérigène. À éviter autant que possible.', en: 'Really concerning: IARC 2A/2B or massive ultra-processed accumulation, one step below a carcinogen. Avoid as much as possible.', ko: '정말 우려스러움: IARC 2A/2B 또는 초가공 성분의 대량 축적, 발암물질 바로 아래 단계. 최대한 피하세요.' },
  ...
  nf_badge_caution: { fr: 'PRÉCAUTION', en: 'OCCASIONAL', ko: '주의' },
  ...
  level_possible_carcinogen: { fr: 'MODÉRATION', en: 'OCCASIONAL', ko: '주의' },
  ...
  risk_moderation_label: { fr: 'MODÉRATION', en: 'OCCASIONAL', ko: '주의' },
  ...
  stat_probable: { fr: 'Transformé', en: 'Processed', ko: '가공' },
  stat_possible: { fr: 'Modération', en: 'Occasional', ko: '주의' },
  stat_safe: { fr: 'Approuvé', en: 'Approved', ko: '승인됨' },
  stats_filter_hint: { fr: 'Touche une catégorie pour filtrer', en: 'Tap a category to filter', ko: '카테고리를 눌러 필터링' },
  ...
  // ===== PAYWALL =====
  paywall_drtoxi: { fr: 'Dr. Toxi devient ton coach illimité', en: 'Dr. Toxi becomes your unlimited coach', ko: 'Dr. Toxi 무제한 코치' },
  paywall_history: { fr: 'Garde ton historique complet', en: 'Keep your full history', ko: '전체 기록 보관' },
  paywall_favorite: { fr: 'Construis ta liste de produits sûrs', en: 'Build your list of safer products', ko: '안전한 제품 목록 만들기' },
  paywall_alerts: { fr: 'Reste alerté avant les mauvais choix', en: 'Stay alerted before bad choices', ko: '나쁜 선택 전 알림 받기' },
  paywall_scan: { fr: 'Analyse tes produits sans limite', en: 'Analyze your products without limits', ko: '제품 무제한 분석' },
  paywall_default: { fr: 'Passe au niveau supérieur avec Dr.Toxi Pro', en: 'Level up with Dr.Toxi Pro', ko: 'Dr.Toxi Pro로 업그레이드' },
  paywall_sub_drtoxi: { fr: 'Tes 3 messages gratuits à vie sont utilisés. Passe en Pro pour garder Dr. Toxi avec toi à chaque choix.', en: "You've used your 3 free lifetime messages. Go Pro to keep Dr. Toxi with you for every choice.", ko: '평생 무료 메시지 3개를 모두 사용했습니다. Pro로 모든 선택에 Dr. Toxi를 함께하세요.' },
  paywall_sub_history: { fr: 'Sans Pro, seuls les 2 derniers produits restent visibles. Débloque une mémoire complète de tes choix.', en: 'Without Pro, only your last 2 products stay visible. Unlock a complete memory of your choices.', ko: 'Pro 없이는 최근 2개 제품만 보입니다. 선택 기록 전체를 잠금 해제하세요.' },
  paywall_sub_favorite: { fr: 'Sauvegarde tes meilleurs produits et retrouve-les au bon moment.', en: 'Save your best products and find them again at the right time.', ko: '좋은 제품을 저장하고 필요할 때 다시 찾으세요.' },
  paywall_sub_alerts: { fr: 'Reçois les alertes importantes sur les produits interdits, toxiques ou cancérigènes.', en: 'Receive important alerts about banned, toxic, or carcinogenic products.', ko: '금지·독성·발암 제품에 대한 중요한 알림을 받으세요.' },
  paywall_sub_scan: { fr: 'Tes 2 scans gratuits du jour sont terminés. Passe en Pro pour scanner sans réfléchir.', en: "You've used your 2 free scans today. Go Pro to scan without thinking twice.", ko: '오늘 무료 스캔 2회를 모두 사용했습니다. Pro로 제한 없이 스캔하세요.' },
  paywall_sub_default: { fr: 'Débloque l’expérience complète : scans, rapports, Dr. Toxi et recommandations intelligentes.', en: 'Unlock the full experience: scans, reports, Dr. Toxi, and smart recommendations.', ko: '스캔, 리포트, Dr. Toxi, 맞춤 추천까지 모두 잠금 해제하세요.' },
  paywall_pro_badge: { fr: 'PRO', en: 'PRO', ko: 'PRO' },
  paywall_limit_reached: { fr: 'Limite gratuite atteinte', en: 'Free limit reached', ko: '무료 한도 도달' },
  paywall_premium_label: { fr: 'Expérience premium', en: 'Premium experience', ko: '프리미엄 경험' },
  paywall_marketing_promise: { fr: 'Passe d’un simple scan à un vrai copilote santé : chaque repas, produit et tendance devient clair en quelques secondes.', en: 'Go from a simple scan to a true health copilot: every meal, product, and trend becomes clear in seconds.', ko: '단순 스캔을 넘어 진짜 건강 코파일럿으로: 식사, 제품, 추세를 몇 초 만에 명확히 확인하세요.' },
  paywall_value_unlimited: { fr: '∞', en: '∞', ko: '∞' },
  paywall_value_unlimited_sub: { fr: 'scans', en: 'scans', ko: '스캔' },
  paywall_value_ai: { fr: 'IA', en: 'AI', ko: 'AI' },
  paywall_value_ai_sub: { fr: 'premium', en: 'premium', ko: '프리미엄' },
  paywall_value_impact: { fr: 'Impact', en: 'Impact', ko: '영향' },
  paywall_value_impact_sub: { fr: 'solidaire', en: 'giving back', ko: '기부' },
  paywall_trust_secure: { fr: 'Achat sécurisé', en: 'Secure purchase', ko: '안전한 결제' },
  paywall_trust_premium_ai: { fr: 'Analyse IA premium', en: 'Premium AI analysis', ko: '프리미엄 AI 분석' },
  paywall_included_eyebrow: { fr: 'Inclus dans Pro', en: 'Included in Pro', ko: 'Pro 포함' },
  paywall_included_title: { fr: 'Tout ce qu’il faut pour choisir mieux', en: 'Everything you need to choose better', ko: '더 나은 선택에 필요한 모든 것' },
  paywall_choose_plan: { fr: 'Choisis ton accès Pro', en: 'Choose your Pro access', ko: 'Pro 이용권 선택' },
  paywall_choose_plan_subtitle: { fr: 'Le plan annuel est sélectionné par défaut : le plus avantageux pour progresser toute l’année.', en: 'Annual is selected by default: the best value to improve all year.', ko: '연간 플랜이 기본 선택입니다: 1년 내내 가장 좋은 가치.' },
  paywall_best_choice: { fr: 'Meilleur choix', en: 'Best choice', ko: '추천' },
  paywall_selected: { fr: 'Choisi', en: 'Selected', ko: '선택됨' },
  paywall_annual_microcopy: { fr: 'L’accès complet pour scanner, comparer et suivre tes progrès toute l’année.', en: 'Full access to scan, compare, and track your progress all year.', ko: '1년 내내 스캔, 비교, 추적하는 전체 이용권.' },
  paywall_annual_perk: { fr: 'Pensé pour transformer tes habitudes, pas juste débloquer une option.', en: 'Built to transform habits, not just unlock a feature.', ko: '기능 잠금 해제를 넘어 습관 변화를 위해 설계.' },
  paywall_monthly_microcopy: { fr: 'Flexible si tu veux essayer Pro à ton rythme.', en: 'Flexible if you want to try Pro at your own pace.', ko: '원하는 속도로 Pro를 사용해 볼 수 있는 유연한 선택.' },
  paywall_impact_title: { fr: 'Ton abonnement sert aussi une cause', en: 'Your subscription also supports a cause', ko: '구독은 의미 있는 일도 지원합니다' },
  paywall_secure_purchase: { fr: 'Paiement App Store sécurisé · résiliable à tout moment', en: 'Secure App Store payment · cancel anytime', ko: '안전한 App Store 결제 · 언제든 해지 가능' },
  ...
  start_free_trial: { fr: "Commencer l'essai gratuit", en: 'Start free trial', ko: '무료 체험 시작하기' },
  start_free_trial_days: { fr: (days: number) => `Essai gratuit ${days} jours`, en: (days: number) => `${days}-day free trial`, ko: (days: number) => `${days}일 무료 체험` },
  subscribe_for_price: { fr: (price: string, period: string) => `S’abonner — ${price}/${period}`, en: (price: string, period: string) => `Subscribe — ${price}/${period}`, ko: (price: string, period: string) => `구독하기 — ${price}/${period}` },
  paywall_monthly_label: { fr: 'Mensuel', en: 'Monthly', ko: '월간' },
  paywall_annual_label: { fr: 'Annuel', en: 'Annual', ko: '연간' },
  paywall_per_month: { fr: 'par mois', en: 'per month', ko: '매월' },
  paywall_per_year: { fr: 'par an', en: 'per year', ko: '매년' },
  paywall_monthly_compact: { fr: 'Flexible, sans engagement annuel', en: 'Flexible, no annual commitment', ko: '연간 약정 없이 유연하게' },
  paywall_trial_banner: { fr: 'Essai gratuit de 7 jours, sans prélèvement', en: '7-day free trial, no charge now', ko: '7일 무료 체험, 지금 결제 없음' },
  paywall_trial_sub: { fr: 'Puis renouvellement automatique · résiliable à tout moment', en: 'Then auto-renews · cancel anytime', ko: '이후 자동 갱신 · 언제든 해지 가능' },
  per_year: { fr: 'an', en: 'year', ko: '년' },
  per_month: { fr: 'mois', en: 'month', ko: '월' },
  paywall_billed_line: { fr: (price: string, period: string) => `${price} / ${period}`, en: (price: string, period: string) => `${price} / ${period}`, ko: (price: string, period: string) => `${price} / ${period}` },
  paywall_billed_prefix: { fr: 'Facturé', en: 'Billed', ko: '청구' },
  paywall_trial_note: { fr: (price: string, period: string) => `Après un essai gratuit de 7 jours, ${price}/${period}. Renouvellement automatique · résiliable à tout moment.`, en: (price: string, period: string) => `After a 7-day free trial, ${price}/${period}. Auto-renews · cancel anytime.`, ko: (price: string, period: string) => `7일 무료 체험 후 ${price}/${period}. 자동 갱신 · 언제든 해지 가능.` },
  paywall_dynamic_trial_note: { fr: (days: number, price: string, period: string) => `Après ${days} jours gratuits, ${price}/${period}. Renouvellement automatique · résiliable à tout moment.`, en: (days: number, price: string, period: string) => `After ${days} free days, ${price}/${period}. Auto-renews · cancel anytime.`, ko: (days: number, price: string, period: string) => `${days}일 무료 체험 후 ${price}/${period}. 자동 갱신 · 언제든 해지 가능.` },
  paywall_no_trial_note: { fr: (price: string, period: string) => `${price}/${period}. Renouvellement automatique · résiliable à tout moment.`, en: (price: string, period: string) => `${price}/${period}. Auto-renews · cancel anytime.`, ko: (price: string, period: string) => `${price}/${period}. 자동 갱신 · 언제든 해지 가능.` },
  donation_text: { fr: "Une partie des revenus aide des patients atteints de cancer à financer leurs traitements et médicaments. Pro protège tes choix — et soutient aussi ceux qui se battent.", en: 'A portion of revenue helps cancer patients fund treatments and medications. Pro protects your choices — and supports people fighting too.', ko: '수익의 일부는 암 환자의 치료와 약값을 지원합니다. Pro는 당신의 선택을 지키고, 싸우는 사람들도 돕습니다.' },
  ...
  verdict_label_toxic: { fr: 'toxique', en: 'toxic', ko: '독성' },
  verdict_label_ultra_toxic: { fr: 'ultra toxique', en: 'ultra toxic', ko: '초독성' },
  ...
  product_scan_limit_msg: { fr: 'Tu as utilisé tes 2 scans produits gratuits du jour. Passe à Pro pour scanner sans limite, ou reviens demain.', en: "You've used your 2 free product scans for today. Go Pro to scan without limits, or come back tomorrow.", ko: '오늘 무료 제품 스캔 2회를 모두 사용했어요. 무제한으로 스캔하려면 Pro로 업그레이드하거나 내일 다시 오세요.' },
  ...
  benefit_unlimited_meal_scans_desc: { fr: 'Analyse chaque assiette sans attendre demain.', en: 'Analyze every plate without waiting until tomorrow.', ko: '내일까지 기다리지 않고 모든 식사를 분석하세요.' },
  benefit_unlimited_product_scans: { fr: 'Scans produits illimités', en: 'Unlimited product scans', ko: '무제한 제품 스캔' },
  benefit_unlimited_product_scans_desc: { fr: 'Décide vite en rayon, sans compteur qui bloque.', en: 'Decide fast in-store without a counter blocking you.', ko: '매장에서 제한 없이 빠르게 결정하세요.' },
  benefit_weekly_report: { fr: 'Rapport hebdo complet + tendance', en: 'Full weekly report + trend', ko: '주간 전체 리포트 + 추세' },
  benefit_weekly_report_desc: { fr: 'Vois tes habitudes, tes progrès et les vrais signaux à corriger.', en: 'See your habits, progress, and the real signals to improve.', ko: '습관, 진행 상황, 개선 신호를 확인하세요.' },
  benefit_recommendations: { fr: 'Recommandations personnalisées', en: 'Personalized recommendations', ko: '맞춤 추천' },
  benefit_recommendations_desc: { fr: 'Des conseils concrets selon tes scans, pas des généralités.', en: 'Concrete advice based on your scans, not generic tips.', ko: '일반 조언이 아닌 스캔 기반 맞춤 조언.' },
  benefit_unlimited_drtoxi_desc: { fr: 'Pose tes questions quand tu veux, au moment du choix.', en: 'Ask whenever you want, right when you need to choose.', ko: '선택의 순간 언제든 질문하세요.' },
