...
const translations = {
  ...
  paywall_sub_drtoxi: { fr: 'Tes 6 messages gratuits à vie sont utilisés. Passe en Pro pour garder Dr. Toxi avec toi à chaque choix.', en: "You've used your 6 free lifetime messages. Go Pro to keep Dr. Toxi with you for every choice.", ko: '평생 무료 메시지 6개를 모두 사용했습니다. Pro로 모든 선택에 Dr. Toxi를 함께하세요.' },
  paywall_sub_history: { fr: 'Sans Pro, seuls les 3 derniers produits restent visibles. Débloque une mémoire complète de tes choix.', en: 'Without Pro, only your last 3 products stay visible. Unlock a complete memory of your choices.', ko: 'Pro 없이는 최근 3개 제품만 보입니다. 선택 기록 전체를 잠금 해제하세요.' },
  ...
  paywall_sub_scan: { fr: 'Tes 3 scans gratuits du jour sont terminés. Passe en Pro pour scanner sans réfléchir.', en: "You've used your 3 free scans today. Go Pro to scan without thinking twice.", ko: '오늘 무료 스캔 3회를 모두 사용했습니다. Pro로 제한 없이 스캔하세요.' },
