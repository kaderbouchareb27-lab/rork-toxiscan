...
[4] VERDICT CONSISTENCY: 1+ danger → badge="danger"; 4+ probable OR 7+ possible → "probable" (EXCEPTION: 1, 2 or 3 isolated oranges among ≥70% naturals → downgrade to "possible"); 2-6 possible → "possible"; otherwise → "aucun".
