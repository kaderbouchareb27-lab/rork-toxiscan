...
export const INGREDIENTS_DATABASE: readonly IngredientEntry[] = [
  ...
  { keywords: ['tbhq'], code: 'E319', risk: 'danger', circ: 'Groupe 1', note: 'Lié à des tumeurs dans des études animales, interdit en Europe.' },
  { keywords: ['bht', 'butylhydroxytoluene'], code: 'E321', risk: 'probable', circ: 'Perturbateur endocrinien', note: 'Perturbateur endocrinien, effets hépatiques à fortes doses.' },
  { keywords: ['polysorbate 60', 'polysorbate 65', 'polysorbate 40', 'polysorbate 20'], code: 'E432-E436', risk: 'probable', circ: 'Perturbateur endocrinien', note: 'Perturbent le microbiome intestinal, favorisent l\'inflammation chronique.' },
  { keywords: ['mono et diglycerides', 'monoglycerides', 'diglycerides', 'mono and diglycerides'], code: 'E471', risk: 'probable', circ: 'Ultra-transformé', note: 'Peuvent contenir des graisses trans cachées issues d\'huiles hydrogénées.' },
  { keywords: ['pgpr', 'polyglycerol polyricinoleate'], code: 'E476', risk: 'probable', circ: 'Ultra-transformé', note: 'Effets sur le foie et les reins à fortes doses.' },
  ...
  { keywords: ['guanylate', 'inosinate'], code: 'E626-E635', risk: 'probable', circ: 'Excitotoxine', note: 'Amplificateurs de MSG, mêmes effets excitotoxiques.' },
  { keywords: ['gomme karaya', 'karaya gum'], code: 'E416', risk: 'probable', circ: 'Allergène', note: 'Allergène reconnu pouvant provoquer des réactions sévères.' },
  { keywords: ['cellulose modifiee', 'modified cellulose', 'methylcellulose', 'hydroxypropyl methylcellulose'], code: 'E463-E465', risk: 'probable', circ: 'Ultra-transformé', note: 'Dérivés chimiques industriels affectant le microbiome.' },
  ...
  { keywords: ['sulfite', 'sulphite', 'dioxyde de soufre', 'sulfur dioxide'], code: 'E220-E228', risk: 'probable', circ: 'Allergène', note: 'Provoque des crises d\'asthme et réactions allergiques sévères.' },
  ...
  { keywords: ['acesulfame', 'acesulfame k', 'acesulfame potassium'], code: 'E950', risk: 'probable', circ: 'Perturbateur endocrinien', note: 'Toujours ORANGE — perturbateur endocrinien qui dégrade le microbiome intestinal, même seul.' },
  ...
  { keywords: ['bha', 'butylhydroxyanisole'], code: 'E320', risk: 'danger', circ: 'Groupe 2B', note: 'Classé cancérigène possible (Groupe 2B CIRC), perturbateur endocrinien.' },
  ...
  { keywords: ['jaune 5', 'yellow 5', 'tartrazine'], code: 'E102', risk: 'danger', circ: 'Groupe 1', note: 'Colorant lié au cancer de la vessie dans des études animales, banni dans plusieurs pays.' },
  { keywords: ['jaune 6', 'yellow 6', 'sunset yellow', 'jaune orange s'], code: 'E110', risk: 'danger', circ: 'Groupe 1', note: 'Colorant azoïque lié au cancer de la vessie, interdit dans certains pays.' },
  { keywords: ['rouge cochenille a', 'ponceau 4r'], code: 'E124', risk: 'danger', circ: 'Groupe 1', note: 'Colorant cancérigène suspecté, interdit aux USA.' },
  { keywords: ['caramel ammoniacal sulfite', 'sulfite ammonia caramel'], code: 'E150d', risk: 'danger', circ: 'Groupe 2B', note: 'Contient du 4-MEI, classé cancérigène possible par le CIRC (Groupe 2B).' },
  { keywords: ['aluminium colorant', 'aluminum e173'], code: 'E173', risk: 'danger', circ: 'Groupe 1', note: 'Métal neurotoxique lié à Alzheimer et perturbations neurologiques.' },
  { keywords: ['ferrocyanure de sodium', 'sodium ferrocyanide'], code: 'E535', risk: 'danger', circ: 'Groupe 1', note: 'Libère du cyanure en milieu acide, toxique à doses élevées.' },
  { keywords: ['phosphate acide aluminium sodium', 'sodium aluminum phosphate'], code: 'E541', risk: 'danger', circ: 'Groupe 1', note: 'Contient de l\'aluminium neurotoxique lié à Alzheimer.' },
