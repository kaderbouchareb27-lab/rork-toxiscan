...
export const INGREDIENTS_DATABASE: readonly IngredientEntry[] = [
  ...
  { keywords: ['sucre de canne', 'cane sugar', 'sucre de canne roux', 'raw cane sugar'], code: null, risk: 'probable', circ: 'Sucre raffiné', note: 'Sucre raffiné, mêmes effets métaboliques que le sucre blanc. / Refined sugar with the same metabolic effects as white sugar.' },
