...
export const INGREDIENTS_DATABASE: readonly IngredientEntry[] = [
  ...
  { keywords: ['sucre de canne', 'cane sugar', 'sucre de canne roux', 'raw cane sugar', 'sucre roux', 'brown sugar', 'sucre brun', 'sucre blond', 'turbinado', 'demerara'], code: null, risk: 'possible', circ: 'Sucre peu raffiné', note: 'Sucre peu transformé qui conserve une partie de la mélasse et des minéraux, mais reste à 90% du saccharose. Provoque les mêmes pics glycémiques que le sucre blanc et contribue à la prise de poids et au diabète de type 2. À consommer avec modération.' },
