...
export const INGREDIENTS_DATABASE: readonly IngredientEntry[] = [
  ...
  { keywords: ['sucre', 'sugar', 'saccharose', 'sucrose', 'sucre blanc', 'white sugar', 'sucre raffiné', 'sucre raffine', 'refined sugar'], code: null, risk: 'probable', circ: 'Sucre raffiné', note: 'Sucre ultra-raffiné par procédé industriel, dépourvu de minéraux et vitamines. Fortement lié à l\'obésité, au diabète de type 2, aux maladies cardiovasculaires et à l\'inflammation chronique. / Ultra-refined sugar stripped of minerals and vitamins. Strongly linked to obesity, type 2 diabetes, cardiovascular disease and chronic inflammation.' },
  { keywords: ['sucre de canne', 'cane sugar', 'sucre de canne roux', 'raw cane sugar', 'sucre roux', 'brown sugar', 'sucre brun', 'sucre blond', 'turbinado', 'demerara'], code: null, risk: 'possible', circ: 'Sucre peu raffiné', note: 'Sucre peu transformé, conserve une partie de la mélasse et des minéraux. À consommer avec modération. / Lightly processed sugar, retains some molasses and minerals. Consume in moderation.' },
  { keywords: ['sucres', 'sugars'], code: null, risk: 'probable', circ: 'Sucre raffiné', note: 'Sucres ajoutés ultra-transformés. À éviter. / Ultra-processed added sugars. Best avoided.' },
  ...
  { keywords: ['sel', 'salt', 'sel marin', 'sel de mer', 'sea salt', 'fleur de sel', 'sel iode', 'sel iodé', 'iodized salt', 'iodised salt', 'sel iodé fin', 'sel de table', 'table salt', 'sel fin', 'fine salt', 'sel rose', 'pink salt', 'sel de l\'himalaya', 'sel d\'himalaya', 'sel himalayen', 'himalayan salt', 'himalayan pink salt', 'sel gemme', 'rock salt', 'sel casher', 'kosher salt', 'sel gris', 'grey salt', 'gray salt', 'sel de guérande', 'sel de guerande', 'sel de cuisine', 'cooking salt', 'sel non iodé', 'sel non iode', 'non-iodized salt', 'chlorure de sodium', 'sodium chloride'], code: null, risk: 'aucun', circ: 'Naturel', note: 'Minéral essentiel au bon fonctionnement de l\'organisme (équilibre hydrique, transmission nerveuse). Problématique uniquement en excès. / Essential mineral for bodily functions (fluid balance, nerve transmission). Only problematic in excess.' },

  // --- Céréales et féculents ---
  { keywords: ['ble', 'blé', 'wheat', 'grain de blé', 'grain de ble', 'wheat grain', 'blé entier', 'ble entier', 'whole wheat', 'farine de ble', 'farine de blé', 'farine complete', 'farine complète', 'farine de blé complète', 'wheat flour', 'whole wheat flour', 'whole flour', 'farine intégrale'], code: null, risk: 'aucun', circ: 'Naturel', note: 'Céréale de base nutritive, source de glucides complexes, fibres, protéines végétales et vitamines du groupe B. La version complète conserve le son et le germe, riches en minéraux. / Nutritious staple grain, source of complex carbs, fiber, plant protein and B vitamins. Whole wheat retains the bran and germ, rich in minerals.' },
  ...
  // --- Sucres naturels ---
  { keywords: ['sucre de coco', 'coconut sugar', 'sucre de fleur de coco', 'coconut flower sugar'], code: null, risk: 'possible', circ: 'Sucre naturel', note: 'Sucre naturel issu de la sève de fleur de cocotier, contient quelques minéraux (potassium, zinc) et un index glycémique légèrement plus bas que le sucre blanc. Reste composé à ~80% de saccharose, à modérer. / Natural sugar from coconut flower sap, contains some minerals (potassium, zinc) with a slightly lower glycemic index than white sugar. Still ~80% sucrose, use in moderation.' },
  { keywords: ['miel', 'honey'], code: null, risk: 'aucun', circ: 'Naturel' },
  { keywords: ['sirop d\'erable', 'sirop d\'érable', 'maple syrup', 'sucre d\'érable', 'maple sugar'], code: null, risk: 'possible', circ: 'Sucre naturel', note: 'Sève d\'érable concentrée, contient des antioxydants et minéraux (manganèse, zinc). IG modéré (~54) mais reste un sucre concentré, à consommer avec modération. / Concentrated maple sap, contains antioxidants and minerals (manganese, zinc). Moderate GI (~54) but still a concentrated sugar, use in moderation.' },
