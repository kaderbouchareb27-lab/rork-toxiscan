...
const FACTS_FR: ScanFact[] = [
  ...
  { id: 3, category: 'plastic', text: '❤️ Une étude du New England Journal of Medicine (2024) a établi un lien direct entre microplastiques dans les artères et risque d\'infarctus ou d\'AVC multiplié par 4,5.', source: 'NEJM / Nature Medicine 2024' },
  ...
  { id: 7, category: 'plastic', text: '♻️ Paradoxe : selon le CNRS Toulouse (janvier 2025), 8 marques d\'eau en bouteille sur 10 contiennent PLUS de microplastiques que l\'eau du robinet. La solution : le filtre à eau.', source: 'CNRS Toulouse, janvier 2025' },
  ...
  { id: 30, category: 'environment', text: "🌧️ Les microplastiques et PFAS ont infiltré le cycle de l'eau : pluie, neige, rivières, nappes phréatiques. Science (2020) en a détecté dans la pluie des parcs nationaux américains.", source: 'Science 2020 / Slate.fr 2025' },
  ...
  { id: 37, category: 'general', text: '🎗️ Le cancer du sein est le plus fréquent chez la femme. Les études lient l\'exposition aux perturbateurs endocriniens (parabènes, phtalates, BPA) au risque accru.', source: 'IARC / Darbre 2004 / EWG' },
...
const FACTS_EN: ScanFact[] = [
  ...
  { id: 3, category: 'plastic', text: '❤️ A NEJM study (2024) established a direct link between microplastics in arteries and a 4.5x higher risk of heart attack or stroke.', source: 'NEJM / Nature Medicine 2024' },
  ...
  { id: 7, category: 'plastic', text: '♻️ Paradox: according to CNRS Toulouse (Jan 2025), 8 out of 10 bottled water brands contain MORE microplastics than tap water. The solution: a water filter.', source: 'CNRS Toulouse, January 2025' },
  ...
  { id: 30, category: 'environment', text: '🌧️ Microplastics and PFAS have infiltrated the water cycle: rain, snow, rivers, groundwater. Science (2020) even detected them in rain over US national parks.', source: 'Science 2020 / Slate.fr 2025' },
  ...
  { id: 37, category: 'general', text: '🎗️ Breast cancer is the most common cancer in women. Studies link exposure to endocrine disruptors (parabens, phthalates, BPA) to increased risk.', source: 'IARC / Darbre 2004 / EWG' },
