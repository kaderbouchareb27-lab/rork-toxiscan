...
export const ADDITIVES_DATABASE: AdditiveInfo[] = [
  ...
  { code: 'en:e110', name: 'Jaune orangé S / Yellow 6', group: 'group2b', description: 'Ce colorant artificiel n\'est pas classé cancérogène par le CIRC. Cependant, des études scientifiques ont détecté des contaminants comme la benzidine (cancérigène Groupe 1) dans sa composition. Des liens avec l\'hyperactivité chez l\'enfant ont été documentés (étude Lancet 2007). La FDA américaine a annoncé son retrait progressif des aliments en 2025. Non classé par le CIRC.' },
  { code: 'en:e129', name: 'Rouge allura / Red 40', group: 'group2b', description: 'Ce colorant artificiel n\'est pas classé cancérogène par le CIRC. Cependant, des études scientifiques ont détecté des contaminants comme la benzidine (cancérigène Groupe 1) dans sa composition. Des liens avec l\'hyperactivité chez l\'enfant ont été documentés (étude Lancet 2007). La FDA américaine a annoncé son retrait progressif des aliments en 2025. Non classé par le CIRC.' },
  { code: 'en:e102', name: 'Tartrazine / Yellow 5', group: 'group2b', description: 'Ce colorant artificiel n\'est pas classé cancérogène par le CIRC. Cependant, des études scientifiques ont détecté des contaminants comme la benzidine (cancérigène Groupe 1) dans sa composition. Des liens avec l\'hyperactivité chez l\'enfant ont été documentés (étude Lancet 2007). La FDA américaine a annoncé son retrait progressif des aliments en 2025. Non classé par le CIRC.' },
  { code: 'en:e143', name: 'Vert solide FCF / Green 3', group: 'group2b', description: 'Ce colorant artificiel n\'est pas classé cancérogène par le CIRC. Cependant, des études scientifiques ont détecté des contaminants comme la benzidine (cancérigène Groupe 1) dans sa composition. Des liens avec l\'hyperactivité chez l\'enfant ont été documentés (étude Lancet 2007). La FDA américaine a annoncé son retrait progressif des aliments en 2025. Non classé par le CIRC.' },
  ...
  { code: 'en:e321', name: 'BHT (Butylhydroxytoluène)', group: 'none', description: 'Classé Groupe 3 par le CIRC/IARC — non classifiable, preuves insuffisantes. Le BHT n\'est PAS un cancérigène. Considéré neutre seul ; uniquement signalé comme substance controversée s\'il est combiné à d\'autres ingrédients problématiques. Non classé cancérogène par le CIRC.' },
  ...
  { code: 'en:e133', name: 'Bleu brillant / Blue 1', group: 'group2b', description: 'Ce colorant artificiel n\'est pas classé cancérogène par le CIRC. Cependant, des études scientifiques ont détecté des contaminants comme la benzidine (cancérigène Groupe 1) dans sa composition. Des liens avec l\'hyperactivité chez l\'enfant ont été documentés (étude Lancet 2007). La FDA américaine a annoncé son retrait progressif des aliments en 2025. Non classé par le CIRC.' },
  { code: 'en:e132', name: 'Indigotine / Blue 2', group: 'group2b', description: 'Ce colorant artificiel n\'est pas classé cancérogène par le CIRC. Cependant, des études scientifiques ont détecté des contaminants comme la benzidine (cancérigène Groupe 1) dans sa composition. Des liens avec l\'hyperactivité chez l\'enfant ont été documentés (étude Lancet 2007). La FDA américaine a annoncé son retrait progressif des aliments en 2025. Non classé par le CIRC.' },
