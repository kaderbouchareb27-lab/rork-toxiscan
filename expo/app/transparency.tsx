  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <View style={styles.providerCard}>
        ...
        <Text style={styles.providerValue}>{pick({ en: 'For meal and product photo analysis we use Qwen3.7 Plus, a Chinese AI technology developed by Alibaba — currently one of the most accurate vision models for recognizing food and ingredients. OpenAI GPT-4o-mini (United States) handles Dr. Toxi chat responses and text analysis, and Google Vision reads label text. Models are accessed via secure providers (OpenRouter and the Rork AI Toolkit) and used only for photo analysis and chat.', fr: "Pour l'analyse des photos de repas et de produits, nous utilisons Qwen3.7 Plus, une technologie d'IA chinoise développée par Alibaba — actuellement l'un des modèles de vision les plus performants pour reconnaître les aliments et les ingrédients. OpenAI GPT-4o-mini (États-Unis) gère les réponses du chat Dr. Toxi et l'analyse de texte, et Google Vision lit le texte des étiquettes. Les modèles sont accédés via des fournisseurs sécurisés (OpenRouter et le Rork AI Toolkit) et utilisés uniquement pour l'analyse photo et le chat.", ko: '식사와 제품 사진 분석에는 알리바바가 개발한 중국 AI 기술인 Qwen3.7 Plus를 사용합니다 — 현재 음식과 성분 인식에 가장 정확한 비전 모델 중 하나입니다. OpenAI GPT-4o-mini(미국)는 Dr. Toxi 채팅 응답과 텍스트 분석을 담당하고, Google Vision은 라벨의 텍스트를 읽습니다. 모델은 보안 제공업체(OpenRouter 및 Rork AI Toolkit)를 통해 사용되며 사진 분석과 채팅에만 사용됩니다.' })}</Text>
      </View>
